Feature: Promotion program from MoF for Mycar: Edit profile passenger not image natitionalIC
    As an passenger,
    ...
    Scenario: 01. Check case update profile with idNumber incorrect format NRIC: ABC
        Given I want to register account
            ...
            | android  | tiki    | +60123456783 | passenger | 1211       | 354741079903994 | MyCar   | 4.64200 | password |
    ...
    Scenario: 05. Check case update profile with idNumber correct format Date of birth: 020102-10-1281
        ...
        Then I should get the object result matches with
            | response                                                                                                      |
            | {"returnCode":200,"response":{"profile":{"gender":0,"dob":"","idNumber":"020102-10-1281","profileStatus":0}}} |
    ...
    Scenario: 08. Check case update profile with idNumber incorrect format Date of birth: 021333101281
        ...
        When I send a web socket request with event and data
            | event       | requestData                                                                                                                                                                                                                                      |
            | editProfile | {"dataObjEncode":"","email":"abc@zing.vn","firstName":"Tiki","lastName":"Customer 03","tips":0,"pegasus":true,"profile":{"gender":0,"dob":"","idNumber":"021333101281","address":{"street":"","city":"","state":",","zipcode":"","country":""}}} |
        Then I should get the object result matches with
            | response                                                                                                    |
    ...
    Scenario: 09. Check case update profile with idNumber correct format Date of birth: 020102101281
        ...
        Then I should get the object result matches with
            | response                                                                                                    |
            | {"returnCode":200,"response":{"profile":{"gender":0,"dob":"","idNumber":"020102101281","profileStatus":0}}} |
